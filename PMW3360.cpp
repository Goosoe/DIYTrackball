...
/**
 * This firmware data needs to be uploaded to the sensor every time it is initialized.
 */
constexpr unsigned short firmware_length = 4094;
constexpr unsigned char firmware_data[] PROGMEM = {    // SROM 0x04
